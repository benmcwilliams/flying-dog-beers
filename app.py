...
#######Clean data
url = 'https://raw.githubusercontent.com/benmcwilliams/flying-dog-beers/master/df_week_32.csv'
df_week = pd.read_csv(url, index_col=0)
df_week=df_week.sort_values(['41'],ascending=False)
...
x_labels=['(Mar) Week 1', 'Week 2', 'Week 3', 'Week 4', '(Apr) Week 5', 'Week 6', 'Week 7', 'Week 8',
         ...
         '(Sep) Week 27','Week 28','Week 29','Week 30','(Oct) Week 31','Week 32']
