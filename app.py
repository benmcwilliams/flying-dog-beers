...
#######Clean data
url = 'https://raw.githubusercontent.com/benmcwilliams/flying-dog-beers/master/df_week_10.csv'
df_week = pd.read_csv(url, index_col=0)
df_week=df_week.sort_values(['29'],ascending=False)
