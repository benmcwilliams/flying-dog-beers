...
#######Clean data
url = 'https://raw.githubusercontent.com/benmcwilliams/flying-dog-beers/master/df_week_46.csv'
df_week = pd.read_csv(url, index_col=0)
df_week=df_week.sort_values(['55'],ascending=False)
